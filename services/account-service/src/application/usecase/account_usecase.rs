...
pub trait AccountUseCase: Send + Sync {
    ...
    async fn get_transaction_history(&self, user_id: Uuid, page: Option<i32>, limit: Option<i32>) -> Result<Vec<crate::domain::entities::transaction::Transaction>, ServiceError>;
    ...
    async fn get_funding_history(&self, user_id: Uuid, page: Option<i32>, limit: Option<i32>) -> Result<Vec<crate::domain::entities::funding_payment::FundingPayment>, ServiceError>;
}
